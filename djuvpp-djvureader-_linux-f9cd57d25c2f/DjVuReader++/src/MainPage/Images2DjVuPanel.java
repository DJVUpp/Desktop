...
public class Images2DjVuPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        wweq.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        wweq.setForeground(new java.awt.Color(0, 0, 102));
        wweq.setText("Select Your Images");
        add(wweq, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        images2djVu.setBackground(new java.awt.Color(204, 51, 0));
        images2djVu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/imageButton 48.png"))); // NOI18N
        ...
        add(images2djVu, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 64, 50));

        df.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/image toDJVU 48.png"))); // NOI18N
        add(df, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 50, 58, 50));
        ...
        add(Djvust, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, -1, 20));
