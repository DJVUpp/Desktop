...
/**
 * This is a factory which stores standard encoding options. Each class implementing DjVuInterface
 * or dirived from DjVuObject should be added here. When a DjVuInterface class creates a new Object,
 * it will use this factory. That way even the core decoding classes may be overloaded simply by
 * setting the DjVuOptions of the top level class. Use of this factor also greatly speeds up the
 * initialization of Microsoft's implementation of Java 1.1.
 *
...
public class DjVuOptions {
    ...
    /**
     * True if garbage collection should be invoked manually on a regular basis. This greatly slows
     * down the code, but it may be neccessary for a low memory device.
     */
    ...
    public static PrintStream out = new PrintStream(new OutputStream() {
        ...
        public void write(final int b) {
            // Set the out stream to None by default.
        }
    });
