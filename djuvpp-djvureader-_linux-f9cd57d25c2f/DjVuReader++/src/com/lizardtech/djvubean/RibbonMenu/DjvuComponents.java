...
import com.lizardtech.djvubean.SelectMode;
...
public class DjvuComponents implements RibbonGetIcon {
    ...
    public JRibbonBand getHomeCommentBand() {
        ...
        Button.createnote.addActionListener(new ActionListener() {
        ...
        Button.shownote = new JCommandMenuButton("Show Note", getResizableIconFromResource(new ImageIcon("/images/icon48.png").toString()));
        ...
        Comment.addCommandButton(Button.UnderLine, RibbonElementPriority.MEDIUM);
        List<RibbonBandResizePolicy> resizePolicies = new ArrayList<RibbonBandResizePolicy>();
                ...
                if(!djvuSelectFullPath.contains(" ")){
                    ...
                    if (d.equals(".djvu")) {
                        ...
                        if(path!=null&&SaveDjVu.getFile()!= null){
                            DjVU2PDF.convertDjvu2PDF(djvuSelectFullPath, "C:\\DjVu++Task\\outp", 0);
...
DjvuRibbonComponents.styleItalicButton.addActionListener(new ActionListener() {
	...
	DjvuRibbonComponents.styleUnderlineButton.addActionListener(new ActionListener() {
        ...
        Button.styleUnderlineButton.setActionKeyTip("3");
        styleStrip.add(Button.styleUnderlineButton);
...
//       // styleStrip.add(Button.styleStrikeThroughButton);
    ...
    public JFlowRibbonBand getParagraphBand() {
        ...
        Button.indentLeftButton = new JCommandButton("", getResizableIconFromResource("/images/indent_left.gif"));
        Button.indentLeftButton.setActionKeyTip("AO");
        Button.indentLeftButton.setDisplayState(CommandButtonDisplayState.SMALL);
        Button.indentRightButton = new JCommandButton("", getResizableIconFromResource("/images/indent_right.gif"));
        Button.indentRightButton.setActionKeyTip("AI");
        Button.indentRightButton.setDisplayState(CommandButtonDisplayState.SMALL);
        intentStrip.add(Button.indentLeftButton);
        intentStrip.add(Button.indentRightButton);

        JCommandButtonStrip alignStrip = new JCommandButtonStrip();
        CommandToggleButtonGroup alignGroup = new CommandToggleButtonGroup();

        Button.alignLeftButton = new JCommandToggleButton("",
                getResizableIconFromResource("/images/justify_left.gif"));
        Button.alignLeftButton.setActionKeyTip("AL");
        //Button.alignLeftButton.getActionModel().setSelected(true);
        alignGroup.add(Button.alignLeftButton);
        alignStrip.add(Button.alignLeftButton);

        Button.alignCenterButton = new JCommandToggleButton("",
                getResizableIconFromResource("/images/justify_Center.gif"));
        Button.alignCenterButton.setActionKeyTip("AC");
        alignGroup.add(Button.alignCenterButton);
        alignStrip.add(Button.alignCenterButton);

        Button.alignRightButton = new JCommandToggleButton("",
                getResizableIconFromResource("/images/justify_right.gif"));
        Button.alignRightButton.setActionKeyTip("AR");
        alignGroup.add(Button.alignRightButton);
        alignStrip.add(Button.alignRightButton);

        Button.alignFillButton = new JCommandToggleButton("",
                getResizableIconFromResource("/images/justify_justify.gif"));
        Button.alignFillButton.setActionKeyTip("AF");
        alignGroup.add(Button.alignFillButton);
        alignStrip.add(Button.alignFillButton);
