...
/**
 * This class implements a random access mapping of input streams and URL connections. For input
 * streams and non-http connections, the mapping is achieved by reading in all the data into memory.
 * Http streams are mapped by reading in data blocks when needed.
 *
...
public class DataPool
    ...
    /**
     * Initialize this map to read the specified URL. If a cached DataPool for this URL exists, it
     * will be returned.
     *
