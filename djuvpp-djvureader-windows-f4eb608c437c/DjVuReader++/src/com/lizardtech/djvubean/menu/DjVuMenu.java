  ...
  implements MouseListener, PropertyChangeListener
{
  ...
  // clipboard listenre
  private final ActionListener clipboardlistener = new ActionListener() {
	
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		
		//System.out.println("salah atwa ");
		setStringToClipboard(null);
  ...
  private MenuItem clipboard=null;
...
//  private DjVuBean djvuBean;
  ...
  public MenuItem getclipboardMenuItem()
  {
	  
    MenuItem retval = clipboard;

    if(retval == null)
    {
      retval = new MenuItem("clear clipboard");
      retval.addActionListener(clipboardlistener);
      clipboard = retval;
    }
      ...
      try
      {
        ...
        switch(listener)
        {
          case 0 : // zoom
          {
            ...
            DjvuRibbonComponents.ZoomB.setSelectedItem(((MenuItem)event.getSource()).getLabel());
        ...
        switch(listener)
        {
          ...
          case 0 : // zoom
          {
            if(item.getState())
            {
              ...
              DjvuRibbonComponents.ZoomB.setSelectedItem(item.getLabel());
