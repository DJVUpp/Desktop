...
public class DefaultTabbedPaneWindow extends JFrame implements ITabbedPaneWindow
{
	...
	private void init( )
	{
		...
		tabbedPane.putClientProperty( JhromeTabbedPaneUI.NEW_TAB_BUTTON_VISIBLE , false );
		...
		tabbedPane.putClientProperty( JhromeTabbedPaneUI.DND_POLICY , new DefaultTabbedPaneDndPolicy( false , false ) );
