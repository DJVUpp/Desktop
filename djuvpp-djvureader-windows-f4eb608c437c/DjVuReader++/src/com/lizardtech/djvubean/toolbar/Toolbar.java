...
public class Toolbar
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    public static final Object[] SELECT_MODE_BUTTON
            = {"Select Mode", "select", null, new Dimension(24, 24)};
     ...
     */
    public final Container pageSelect;
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    protected final ToggleButton selectMode;
    ...
    public Toolbar(final DjVuBean bean) {
        ...
        //////////////////////////////////////////////////////////////////////
        selectMode = createToggleButton(SELECT_MODE_BUTTON);
        ...
        /////////////////////////////////////////////////////////////////////////////
        modeButtonPanel.add(selectMode);
...
//    zoomPagePanel.setLayout(new FlowLayout(FlowLayout.LEFT, 1, 1));
        ...
        if (bean.getTextSearchObject() != null) {
            add(new Finder(bean), BorderLayout.SOUTH);
        }
    ...
    public void itemStateChanged(ItemEvent event) {
        try {
            ...
            if (panMode == source) {
                ...
                } else if (!(textMode.isSelected() || zoomMode.isSelected() || selectMode.isSelected())) {
                    djvuBean.setMode(DjVuBean.LAST_MODE);
                }
            } else if (textMode == source) {
                if (textMode.isSelected()) {
                    djvuBean.setMode(DjVuBean.TEXT_MODE);
                } else if (!(panMode.isSelected() || zoomMode.isSelected() || selectMode.isSelected())) {
                    djvuBean.setMode(DjVuBean.LAST_MODE);
                }
            } else if (zoomMode == source) {
                if (zoomMode.isSelected()) {
                    djvuBean.setMode(DjVuBean.ZOOM_MODE);
                } else if (!(panMode.isSelected() || textMode.isSelected() || selectMode.isSelected())) {
                    djvuBean.setMode(DjVuBean.LAST_MODE);
                }
            } else if (selectMode == source) {
                if (selectMode.isSelected()) {
                    djvuBean.setMode(DjVuBean.SELECT_MODE);
                } else if (!(panMode.isSelected() || textMode.isSelected() || zoomMode.isSelected())) {
                    djvuBean.setMode(DjVuBean.LAST_MODE);
                }
...
//          bottom.add(pageSelect);
     ...
     * can change the button properties by overloading this method. For example,
     * if one wanted to replace the LizardTech logo with a Foxtrot Technologies
     * logo one could use the following code:
     * <pre>
    ...
    /**
     * Create a logo button using the specified arguments. Children classes can
     * change the button properties by overloading this class. For example, if
     * one wanted to replace the text used for Pan mode, one could use the
     * following code:
     * <pre>
...
//        : null, icon, selected);
    ...
    private void addComponent(Container container, Component comp, GridBagLayout gridBag, GridBagConstraints c) {
        if (comp != null) {
